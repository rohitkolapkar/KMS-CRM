...
$emp_qry= "select * from complaint_details where employee_id='$session_id' and complaint_status='pending'"; 
           ...
           <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                    $complaint_qry= "select complaint_details.complaint_id, complaint_details.complaint_status, complaint_details.complaint_date, customer_details.customer_name, customer_details.customer_mobile, company_details.company_name, category_details.category_name, model_details.model_name from complaint_details left join customer_details on complaint_details.customer_id=customer_details.customer_id left join company_details on complaint_details.company_id=company_details.company_id LEFT join category_details on complaint_details.category_id=category_details.category_id LEFT join model_details on complaint_details.model_id=model_details.model_id where complaint_details.employee_id='1002' and complaint_details.complaint_status = 'pending'"; 
                    $run=mysqli_query($dbcon,$complaint_qry);
                    $count=1;
                  ?>
                      ...
                      if($color_count>4)
                        ...
                        <tr class="<?php echo $tbl_color[$color_count]; $color_count++;?>">
                          ...
                          <td style="padding-top: 0px; padding-bottom: 0px; padding-left: 5px;padding-right: 5px;">
                            <a href="update_complaint.php?complaint_id=<?php echo $complaint_id;?>" class="btn btn-icons btn-rounded btn-warning">
