...
$query= @"INSERT INTO `customer_details` (`customer_name`,`customer_address`,`city_id`,
                                  ...
                                  VALUES ('$cust_name','$cust_add','$cust_city','$cust_mob','$cust_email')";
if(mysqli_query($dbcon,$query))
{
  ...
  echo "<script>window.open('create_user.php?emp_id=$cust_id','_self')</script>";*/
}
else
{
  echo "<script>alert('Customer details not saved!')</script>";
}
      ...
      <div class="main-panel">
        <div class="content-wrapper">
             ...
             <div class="col-12 grid-margin" >
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" method="POST" action="add_customer.php" >
          ...
          <div class="col-md-6" align="right">
                        <button type="submit" class="btn btn-success btn-rounded btn-md "name="submit_customer">Save</button>
