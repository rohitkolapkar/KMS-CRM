		...
		<div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                    $cust_qry= "SELECT * FROM `customer_details`"; 
                      ...
                      if($color_count>4)
                        ...
                        <tr class="<?php echo $tbl_color[$color_count]; $color_count++;?>">
                          ...
                          <td style="padding-top: 0px; padding-bottom: 0px; padding-left: 5px;padding-right: 5px;">
                            <a href="edit_customer.php?cust_id=<?php echo $cust_id;?>" class="btn btn-icons btn-rounded btn-warning">
                              <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
                            <button type="button" name="delete_cust" value="delete_cust" class="btn btn-icons btn-rounded btn-danger" onclick="deleteCust('<?php echo $cust_id;?>')">
