...
--
-- Host: localhost
-- Generation Time: Oct 06, 2018 at 11:49 AM
...
CREATE TABLE IF NOT EXISTS `customer_details` (
  ...
  UNIQUE KEY `cust_email_id` (`customer_email`),
  UNIQUE KEY `cust_mobile_no` (`customer_mobile`),
  KEY `cust_details_ibfk_1` (`city_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
(1000, 'Altaf R Chaudhari ', 9730049151, 'admin@gmail.com', 'cidco', 29, '2018-10-12', 'male', '000000000', NULL),
(1001, 'Yogesh Technician', 0, 'employee@gmail.com', 'cidco', 196, '2018-10-09', 'male', '000000000', NULL),
(1002, 'Umesh DEP', 0, 'umesh@gmail.com', 'cidco', 405, '2018-10-18', 'male', '000000000', NULL),
...
(1017, 'Rohit', 3424234, 'dasd@sfds.dd', 'dsad', 127, '2018-10-04', 'male', NULL, NULL),
(1019, 'zubair', 3453, 'sdfhj@fsdf.cs', 'sadad', 506, '2018-10-16', 'male', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `model_details` (
  ...
  UNIQUE KEY `uk_modelName_categoryId` (`model_name`,`category_id`),
  KEY `category_id` (`category_id`)
...
(1, 1000, 'caf1a3dfb505ffed0d024130f58c5cfa', 'In what city were you born?', 'Aurangabad', 'admin'),
(2, 1001, '202cb962ac59075b964b07152d234b70', NULL, NULL, 'technician'),
(4, 1002, '202cb962ac59075b964b07152d234b70', NULL, NULL, 'dep'),
(24, 1019, '202cb962ac59075b964b07152d234b70', 'What is your favorite food?', 'biryani', 'technician');
