                  ...
                  <form class="form-sample">
				   ...
				   <div class="col-md-6">
					...
					<div class="col-md-6" align="right">
						<button type="button" class="btn btn-primary btn-rounded btn-md" name="update">Update</button>
                        <button type="button" class="btn btn-danger btn-rounded btn-md" name="delete">Delete</button>
